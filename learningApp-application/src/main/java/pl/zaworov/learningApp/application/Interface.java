...
public class Interface {
	...
	private static void showRivers() {
		...
		if (riverDao.getListOfRivers().size() > riverNumber) {
			...
			System.out.println("Chosen river is named " + chosenRiver.getRiverName() + ", its length is "
					+ chosenRiver.getRiverLength() + ", it's situated in" + chosenRiver.getRiverLocation().toString());
		} else {
